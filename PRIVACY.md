...
<!--
CANONICAL SOURCE. This file and the hosted copy at the Digestly site repo
(Leggysaurus/digestly-site, privacy.md) must stay byte-identical apart from this
comment. They silently diverged once before — the hosted copy gained the Apple
Health section while this one gained the Photos section — so if you edit either,
copy it across in the same commit.
-->
